...
const HeaderBottom = () => {
  ...
  return (
    <div className="w-full px-4 h-[36px] bg-amazon_light text-white flex items-center">
      ...
      <ul className="flex items-center md:gap-4 gap-1 md:text-sm tracking-wide text-xs ">
        <li
        ...
        <li className="  md:inline-flex headerhover">Today's Deals</li>
        <li className=" md:inline-flex headerhover">Customer Service</li>
        <li className="hidden md:inline-flex headerhover">Gift Cards</li>
        <li className=" md:inline-flex headerhover">Registry</li>
